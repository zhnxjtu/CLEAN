...
from test import train_eval_single_ckpt, train_eval_single_ckpt_with_teacher
...
def main():
    ...
    # train_eval_single_ckpt_with_teacher(
    #     model.module if dist_train else model, teacher_model,
    #     test_loader, args, eval_output_dir, logger, 
    #     args.start_epoch, ckpt_dir, dist_test=dist_train
    # )
